...
def run_accuracy_test():
    ...
    if len(set(y)) < 2:
        logging.error("Nicht genügend verschiedene Kategorien für einen Test-Split vorhanden.")
        return
    ...
    # Split in Training (80%) und Test (20%)
    # stratify=y sorgt dafür, dass das Verhältnis der Kategorien in beiden Sets gleich bleibt
